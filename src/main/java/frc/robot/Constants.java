...
public final class Constants {
  ...
  public static final class FuelConstants {
    ...
    public static final int FEEDER_MOTOR_CURRENT_LIMIT = 35;
    ...
    public static final double LAUNCHING_FEEDER_VOLTAGE = 3;
    public static final double LAUNCHING_LAUNCHER_VOLTAGE = 9; //10.6
